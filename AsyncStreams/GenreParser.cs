    ...
    public static class GenreParser
    {
        ...
        static GenreParser()
        {
            ...
            foreach (var fieldInfo in fieldInfos)
            {
                ...
                {
                    StringToGenreMappings.Add(fieldInfo.Name.ToLower(Thread.CurrentThread.CurrentCulture), genre);
                ...
                else
                {
                    ...
                    {
                        StringToGenreMappings.Add(enumDescriptionAttribute.Description.ToLower(Thread.CurrentThread.CurrentCulture), genre);
                    }
                }
            }
